#include "file-helper.hpp"

std::vector<char> FileHelper::readBinary(string path) {
...
void FileHelper::writeBinary(string path,std::vector<std::uint8_t> buffer) {
...
string FileHelper::readToString(string path) {
...
vector<string> FileHelper::readToStrings(string path) {
